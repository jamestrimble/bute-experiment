...
lines = [line for line in lines[1:] if line[0]=="pace"]
...
with open("results/pace.tex", "w") as f:
...
#    f.write("\\scriptsize\n")
    ...
    f.write(" \\bottomrule\n")
    f.write(" \\end{tabular}\n")
    f.write(" \\caption{{Solving times in seconds for PACE graphs}}\n")
    f.write(" \\label{table:pace}\n")
    f.write("\\end{table}\n")
