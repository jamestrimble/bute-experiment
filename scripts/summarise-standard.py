...
lines = [line for line in lines[1:] if line[0]=="standard"]
...
with open("results/standard.tex", "w") as f:
...
#    f.write("\\scriptsize\n")
    ...
    f.write(" \\bottomrule\n")
    f.write(" \\end{tabular}\n")
    f.write(" \\caption{{Solving times in seconds for standard graphs}}\n")
    f.write(" \\label{table:standard}\n")
    f.write("\\end{table}\n")
